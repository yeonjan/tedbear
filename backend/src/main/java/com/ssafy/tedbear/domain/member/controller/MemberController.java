...
public class MemberController {
    ...
    public ResponseEntity saveProblemResult(@AuthenticationPrincipal CustomOAuth2User user, @RequestBody ProblemDto.Request request) {
    ...
    @PutMapping("/feel")
    public ResponseEntity<?> updateScoreByFeel(@AuthenticationPrincipal CustomOAuth2User user, @RequestBody FeelDto feelDto) {
